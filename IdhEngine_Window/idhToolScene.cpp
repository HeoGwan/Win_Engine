...
LRESULT CALLBACK WndTileProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN:
    {
		...
		idh::math::Vector2 mousePosition;
		mousePosition.x = mousePos.x;
		mousePosition.y = mousePos.y;

		int idxX = mousePos.x / idh::TilemapRenderer::OriginTileSize.x;
		int idxY = mousePos.y / idh::TilemapRenderer::OriginTileSize.y;

		idh::TilemapRenderer::SelectedIndex = Vector2(idxX, idxY);
    }
    break;
    case WM_PAINT:
    {
